...
Doesn't look very different - let's get fancy
...
R's data files have an `.rda` extension - .rda files:
...
Or click the &#128190; icon at the top of the scripting window
...
- [Econometrics with R](https://www.econometrics-with-r.org/): textbook for metrics in R
